...
if( $subtitle ) { ?>
    <<?php echo esc_html($subtitle_tag); ?> class="intro_subtitle <?php echo $style; ?>" style="color: <?php echo $subtitle_color; ?>;"><?php echo $subtitle; ?></<?php echo esc_html($subtitle_tag); ?>>
<?php }